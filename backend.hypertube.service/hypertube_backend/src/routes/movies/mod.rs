...
mod set_favorite_movie;
mod remove_favorite_movie;
mod set_watched_movie;
...
pub use set_favorite_movie::*;
pub use remove_favorite_movie::*;
pub use set_watched_movie::*;
pub use get_watched_movies::*;